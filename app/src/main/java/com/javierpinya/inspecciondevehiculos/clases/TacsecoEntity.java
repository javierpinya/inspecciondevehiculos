...
@Entity(tableName = Constans.NAME_TABLE_TACSECO,
...
public class TacsecoEntity {
    ...
    public TacsecoEntity(String matricula, Date fec_cadu_itv, Date fec_cadu_adr, int tara, int peso_maximo, int chip, String tipo, Date fec_cadu_calibracion, int num_ejes, boolean ind_carga_pesados, String cod_nacion, boolean solo_gasoleos, boolean ind_bloqueo, boolean ind_queroseno) {
