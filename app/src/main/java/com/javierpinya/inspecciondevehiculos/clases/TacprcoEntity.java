...
@Entity(tableName = Constans.NAME_TABLE_TACPRCO,
...
public class TacprcoEntity {
    ...
    public TacprcoEntity(String matricula, Date fec_cadu_itv, Date fec_cadu_adr, int tara, int peso_maximo, int chip, String tipo, String cod_nacion, boolean solo_gasoleos, boolean ind_bloqueo, boolean ind_queroseno) {
